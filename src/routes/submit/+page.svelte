...
{#if enviado}
	<div class="text-center py-20">
		...
		<h2 class="text-2xl font-bold text-gray-900 mb-2">¡Gracias por tu sugerencia!</h2>
		<p class="text-gray-500">La revisaremos y la publicaremos pronto.</p>
		<a href="#" class="mt-6 inline-block text-blue-600 hover:underline">Volver al inicio</a>
	</div>
{:else}
	<div class="max-w-xl mx-auto">
		<h1 class="text-3xl font-bold text-gray-900 mb-2">Sugerir recurso</h1>
		<p class="text-gray-500 mb-8">Lo revisaremos antes de publicarlo.</p>
