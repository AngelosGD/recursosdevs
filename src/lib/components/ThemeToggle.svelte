...
>
	<span
		class="absolute top-1 left-1 w-6 h-6 rounded-full flex items-center justify-center transition-all duration-300 shadow-md"
		style="background: white; transform: translateX({isDark ? '24px' : '0'})"
	>
		{#if isDark}
